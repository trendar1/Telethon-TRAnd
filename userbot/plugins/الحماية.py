...
@VV399.iq_cmd(incoming=True, func=lambda e: e.is_private, edited=False, forword=None)
...
@VV399.iq_cmd(outgoing=True, func=lambda e: e.is_private, edited=False, forword=None)
...
@VV399.tgbot.on(CallbackQuery(data=re.compile(rb"show_pmpermit_options")))
...
@VV399.tgbot.on(CallbackQuery(data=re.compile(rb"to_enquire_something")))
async def on_plug_in_callback_query_handler(event):
    if event.query.user_id == event.client.uid:
        text = "**᥀︙   عـذرا ، هـذه الـخـيـارات لـلـمـسـتـخـدم الـذي يـراسـلـك 🧸♥️**"
        return await event.answer(text, cache_time=0, alert=True)
...
@VV399.tgbot.on(CallbackQuery(data=re.compile(rb"to_request_something")))
async def on_plug_in_callback_query_handler(event):
    if event.query.user_id == event.client.uid:
        text = "**᥀︙   عـذرا ، هـذه الـخـيـارات لـلـمـسـتـخـدم الـذي يـراسـلـك 🧸♥️**"
        return await event.answer(text, cache_time=0, alert=True)
...
@VV399.tgbot.on(CallbackQuery(data=re.compile(rb"to_chat_with_my_master")))
async def on_plug_in_callback_query_handler(event):
    if event.query.user_id == event.client.uid:
        text = "**᥀︙   عـذرا ، هـذه الـخـيـارات لـلـمـسـتـخـدم الـذي يـراسـلـك 🧸♥️**"
        return await event.answer(text, cache_time=0, alert=True)
...
@VV399.tgbot.on(CallbackQuery(data=re.compile(rb"to_spam_my_master_inbox")))
async def on_plug_in_callback_query_handler(event):
    if event.query.user_id == event.client.uid:
        text = "**᥀︙   عـذرا ، هـذه الـخـيـارات لـلـمـسـتـخـدم الـذي يـراسـلـك 🧸♥️**"
        return await event.answer(text, cache_time=0, alert=True)
    ...
    sqllist.rm_from_list("pmoptions", event.query.user_id)
    await event.edit(text)
@VV399.on(admin_cmd(pattern="الحماية (تشغيل|ايقاف)(?: |$)(.*)"))
...
async def pmpermit_on(event):
    ...
    if input_str == "ايقاف":
        ...
        await edit_delete(event, "**᥀︙  امـر الـحـمـايـة بـالـفـعـل مُـمَـكـن لـحـسـابـك  🌿**")
@VV399.on(admin_cmd(pattern="(ق|قبول)(?:\s|$)([\s\S]*)"))
...
@VV399.on(admin_cmd(pattern="(ر|رفض)(?:\s|$)([\s\S]*)"))
...
@VV399.on(admin_cmd(pattern="مرفوض(?:\s|$)([\s\S]*)"))
...
@VV399.on(admin_cmd(pattern="مقبول(?:\s|$)([\s\S]*)"))
...
@VV399.on(admin_cmd(pattern="المقبولين(?: |$)(.*)"))
